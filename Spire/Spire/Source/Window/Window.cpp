...
namespace Spire {
    ...
    void Window::SetCursorPos(glm::uvec2 mousePos) {
        glfwSetCursorPos(m_windowHandle, mousePos.x, mousePos.y);
        m_mousePos = glm::vec2(mousePos);
        m_mouseRawPos = glm::vec2(mousePos);
