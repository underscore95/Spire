...
#define SPIRE_VOXEL_CHUNK_DIMENSIONS_FLOAT SPIRE_VEC3_TYPE(SPIRE_VOXEL_CHUNK_SIZE, SPIRE_VOXEL_CHUNK_SIZE, SPIRE_VOXEL_CHUNK_SIZE)
...
#define SPIRE_VOXEL_FACE_NEG_Z 5
    ...
    SPIRE_KEYWORD_NODISCARD SPIRE_KEYWORD_INLINE SPIRE_VEC3_TYPE FaceToDirectionFloat(SPIRE_UINT32_TYPE face) {
