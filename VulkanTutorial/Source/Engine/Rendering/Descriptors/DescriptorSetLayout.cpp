...
std::vector<Descriptor>::const_iterator DescriptorSetLayout::begin() const
{
    return m_descriptors.begin();
}

std::vector<Descriptor>::const_iterator DescriptorSetLayout::end() const
{
    return m_descriptors.end();
}

void DescriptorSetLayout::GenerateLayout()
{
